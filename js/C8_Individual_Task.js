...
function setupLights() {
    gl.uniform3fv(shaderProgram.uniformLightPosition, [0.0, -10.0, 0.0]);
    gl.uniform3fv(shaderProgram.uniformDiffuseLightColor, [0.7,5.0,1.0]);
}
// установка материалов
function setupMaterials() {
    gl.uniform3fv(shaderProgram.uniformDiffuseMaterialColor, [0.0, 1.7, 0.7]);
}
